...
public class TestCases {
	...
	public void queSePuedaPlanearLaBatallaSobreElOceano() throws VehiculoInexistente, VehiculoIncompatible {
		...
		argentina.crearBatalla("Naval", 100.5, 20.3, "San Lorenzo");
		...
		argentina.crearBatalla("San Lorenzo", TipoDeBatalla.NAVAL, 100.5, 20.3);

		assertTrue(argentina.enviarALaBatalla("San Lorenzo", 8));
		assertTrue(argentina.enviarALaBatalla("San Lorenzo", 12));
		assertTrue(argentina.enviarALaBatalla("San Lorenzo", 9));		
	}
	...
	public void queSePuedaPresentarBatallaNaval() throws VehiculoInexistente, VehiculoIncompatible {
		...
		assertEquals(6, argentina.getCapacidadDeDefensa(),0.01);
