...
public class TestNaturaleza {
	...
	private static final int ARANA = 1;
	...
	public static Animal crearAnimales(){
		...
		case HORMIGA:
			return new Invertebrado("Peque�o, rojo o negro, con 6 patas");
		case CANGREJO:
			return new Invertebrado("Rojizo o amarillo. Camina de costado");
		case PEZ_PAYASO:
			return new Pez("Peque�a", "De muchos colores", "De colores");
		case TIBURON:
			return new Pez("Con dientes filosos", "Largo", "Largas");
		case HIPOPOTAMO:
			return new Anfibio("Redonda", "Redondo", "Cortas");
		case HALCON:
			return new Ave("Con pico de rapi�a", "Poderoso", "Alas enormes");
		case COLIBRI:
			return new Ave("Peque�a", "De colores", "Alas rap�disimas");
		case COCODRILO:
			return new Reptil("Con boca enorme", "Muy largo", "Patas cortas y cola larga");
		case IGUANA:
			return new Reptil("Con lengua larga", "Peque�o", "Patas peque�as. Cola finita");
		case LEON:
			return new Carnivoro("Con melena", "Con pelo corto", "Cuatro patas y cola");
		case LEOPARDO:
			return new Carnivoro("Con orejas peque�as", "Con manchas", "Cuatro patas y cola");
		case CABALLO:
		...
		default:
			return new Humano("Peque�a", "Erguido", "Dos piernas y dos brazos");
		}
	}
