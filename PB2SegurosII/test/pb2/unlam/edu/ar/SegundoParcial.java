...
public class SegundoParcial {
	...
	public void queSePuedaEmitirUnaPolizaDeVida() {
		...
		assertEquals(new Integer(2), ((PolizaAccidentesPersonales)poliza).obtenerCantidadDeBeneficiario());
		assertEquals(asegurado, poliza.getAsegurado());
		assertEquals(PREMIO, poliza.getPremio());
	}
	...
	public void queSePuedaEmitirUnaPolizaDeCombinadoFamiliar() {
		...
		assertEquals(new Integer (3),((PolizaCombinadoFamiliar)poliza).obtenerCantidadDeBeneficiario());
		assertEquals(asegurado, poliza.getAsegurado());
		assertEquals(PREMIO, poliza.getPremio());
	}
	
	@Test
	public void queSePuedanAdministrarDistintosTiposDePolizas() throws PolizaInexistente {
